...
gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint = class Checkpoint extends gdjs.RuntimeBehavior {
  constructor(instanceContainer, behaviorData, owner) {
    ...
    this._behaviorData = {};
    this._sharedData = gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint.getSharedData(
      instanceContainer,
      behaviorData.name
    );
  ...
  _toggleActivated() {
    this._setActivated(!this._getActivated());
  }
  _getAnimationActive() {
  ...
  _toggleJustActivated() {
    this._setJustActivated(!this._getJustActivated());
  }
  _getJustDeactivated() {
  ...
  _toggleJustDeactivated() {
    this._setJustDeactivated(!this._getJustDeactivated());
  }
}

/**
 * Shared data generated from Simple Checkpoint
 */
gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint.SharedData = class CheckpointSharedData {
...
gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint.getSharedData = function(instanceContainer, behaviorName) {
  if (!instanceContainer._SimpleCheckpoints_CheckpointSharedData) {
    const initialData = instanceContainer.getInitialSharedDataForBehavior(
      behaviorName
    );
    instanceContainer._SimpleCheckpoints_CheckpointSharedData = new gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint.SharedData(
      initialData
    );
  }
  return instanceContainer._SimpleCheckpoints_CheckpointSharedData;
}
...
gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint.prototype.doStepPreEventsContext.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(13821196);
}
}}
...
{
{gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint.prototype.doStepPreEventsContext.conditionTrue_1 = gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint.prototype.doStepPreEventsContext.condition1IsTrue_0;
gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint.prototype.doStepPreEventsContext.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(13822076);
}
}}
if (gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint.prototype.doStepPreEventsContext.condition1IsTrue_0.val) {
/* Reuse gdjs.evtsExt__SimpleCheckpoints__Checkpoint.Checkpoint.prototype.doStepPreEventsContext.GDObjectObjects1 */
