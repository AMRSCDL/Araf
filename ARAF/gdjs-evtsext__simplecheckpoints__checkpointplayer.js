...
gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer = class CheckpointPlayer extends gdjs.RuntimeBehavior {
  constructor(instanceContainer, behaviorData, owner) {
    ...
    this._behaviorData = {};
    this._sharedData = gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.getSharedData(
      instanceContainer,
      behaviorData.name
    );
  ...
  _toggleAutoSaveSpawnpoint() {
    this._setAutoSaveSpawnpoint(!this._getAutoSaveSpawnpoint());
  }
...
/**
 * Shared data generated from Simple Checkpoint Player
 */
gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.SharedData = class CheckpointPlayerSharedData {
...
gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.getSharedData = function(instanceContainer, behaviorName) {
  if (!instanceContainer._SimpleCheckpoints_CheckpointPlayerSharedData) {
    const initialData = instanceContainer.getInitialSharedDataForBehavior(
      behaviorName
    );
    instanceContainer._SimpleCheckpoints_CheckpointPlayerSharedData = new gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.SharedData(
      initialData
    );
  }
  return instanceContainer._SimpleCheckpoints_CheckpointPlayerSharedData;
}
...
{
{runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageName").setString((typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("StorageName") : ""));
}{runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageGroup").setString((typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("Group") : ""));
}}
...
{runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageName").setString((( gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.WriteSpawnContext.GDObjectObjects1.length === 0 ) ? "" :gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.WriteSpawnContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getDefaultSpawnpointStorageName()));
}}
...
gdjs.copyArray(eventsFunctionContext.getObjects("Object"), gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.WriteSpawnContext.GDObjectObjects1);
{runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageGroup").setString((( gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.WriteSpawnContext.GDObjectObjects1.length === 0 ) ? "" :gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.WriteSpawnContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getDefaultSpawnpointStorageGroup()));
}}
...
{
gdjs.copyArray(eventsFunctionContext.getObjects("Object"), gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.WriteSpawnContext.GDObjectObjects1);
{gdjs.evtTools.storage.writeNumberInJSONFile(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageName")), gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageGroup")) + ".SpawnX", (( gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.WriteSpawnContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.WriteSpawnContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getSpawnPointX()));
}{gdjs.evtTools.storage.writeNumberInJSONFile(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageName")), gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageGroup")) + ".SpawnY", (( gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.WriteSpawnContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.WriteSpawnContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getSpawnPointY()));
}}
...
{runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageName").setString((( gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.ReadSpawnContext.GDObjectObjects1.length === 0 ) ? "" :gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.ReadSpawnContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getDefaultSpawnpointStorageName()));
}}
...
gdjs.copyArray(eventsFunctionContext.getObjects("Object"), gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.ReadSpawnContext.GDObjectObjects1);
{runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageGroup").setString((( gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.ReadSpawnContext.GDObjectObjects1.length === 0 ) ? "" :gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.ReadSpawnContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getDefaultSpawnpointStorageGroup()));
}}
...
{
{gdjs.evtTools.storage.readNumberFromJSONFile(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageName")), gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageGroup")) + ".SpawnX", runtimeScene, runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempSpawnX"));
}{gdjs.evtTools.storage.readNumberFromJSONFile(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageName")), gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempStorageGroup")) + ".SpawnY", runtimeScene, runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempSpawnY"));
}}
...
{for(var i = 0, len = gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.ReadSpawnContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.ReadSpawnContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setSpawnPointX(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempSpawnX")));
}
}{for(var i = 0, len = gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.ReadSpawnContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__SimpleCheckpoints__CheckpointPlayer.CheckpointPlayer.prototype.ReadSpawnContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setSpawnPointY(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__SimpleCheckpoints").getChild("TempSpawnY")));
}
}}
